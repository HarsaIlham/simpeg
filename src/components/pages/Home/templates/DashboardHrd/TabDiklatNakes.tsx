...
interface TabDiklatNakesProps {
    data: DashboardHrdDiklat | null;
    isLoading: boolean;
}

const TabDiklatNakes = ({ data, isLoading }: TabDiklatNakesProps) => {
        ...
        <>
            <div className={styles.statsRow}>
                <StatCard
                    ...
                    label="Total Diklat Tenaga Kesehatan"
                    icon={<Users size={24} />}
                    variant="green"
                    isLoading={isLoading}
                />
            ...
            <div className={styles.chartsGrid}>
                ...
                />
                <BarChartWidget
                    title="Kategori Diklat Tenaga Kesehatan"
